...
X_stage_train = X_stage_train[:, keep_idx]
X_stage_valid = X_stage_valid[:, keep_idx]
X_stage_test = X_stage_test[:, keep_idx]

print()
print("=" * 70)
print("KDIGO 변수 제거 후")
print("=" * 70)
print(f"남은 변수 수 : {len(FEATURE_NAMES)}")
print()
print(FEATURE_NAMES)
print()

print("Train Shape :", X_stage_train.shape)
print("Valid Shape :", X_stage_valid.shape)
print("Test Shape  :", X_stage_test.shape)
...
X_stage_train, y_stage_train_mc = smote.fit_resample(
    X_stage_train,
    y_stage_train_mc
)
...
print(
    pd.Series(y_stage_train_mc)
    .value_counts()
)

print(type(X_stage_train))
print(type(y_stage_train_mc))

print(X_stage_train.shape)
print(y_stage_train_mc.shape)
