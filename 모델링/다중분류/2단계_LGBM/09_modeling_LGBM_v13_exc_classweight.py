# ==========================================================
# 09_modeling_LGBM_v13_exc_classweight.py
# Stage1 vs Stage2+3 | Excluded 28개 | class_weight
# ==========================================================
...
OUT_DIR = "outputs/LGBM_v13_exc_classweight"
...
print("=" * 70)
print("LGBM v13 | Excluded 28개 | class_weight | Stage1 vs Stage2+3")
print("=" * 70)
...
print(f"Stage2+3 Recall: {test_s23r:.4f}")
...
plt.title("Confusion Matrix (v13 exc classweight)"); plt.tight_layout()
...
sns.heatmap(cm_pct,annot=True,fmt='.1%',cmap='Blues',
            xticklabels=["Stage1","Stage2+3"],yticklabels=["Stage1","Stage2+3"])
plt.title("Normalized CM (v13 exc classweight)"); plt.tight_layout()
...
plt.title("ROC Curve (v13 exc classweight)")
...
plt.title("Performance (v13 exc classweight)"); plt.tight_layout()
...
plt.title("Top 15 (v13 exc classweight)")
