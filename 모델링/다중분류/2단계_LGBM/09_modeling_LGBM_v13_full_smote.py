# ==========================================================
# 09_modeling_LGBM_v13_full_smote.py
# Stage1 vs Stage2+3 | Full 35개 | SMOTE
# ==========================================================
...
OUT_DIR = "outputs/LGBM_v13_full_smote"
...
print("=" * 70)
print("LGBM v13 | Full 35개 | SMOTE | Stage1 vs Stage2+3")
print("=" * 70)
...
plt.title("Confusion Matrix (v13 full smote)")
plt.tight_layout()
...
sns.heatmap(cm_pct, annot=True, fmt='.1%', cmap='Blues',
            xticklabels=["Stage1","Stage2+3"],
            yticklabels=["Stage1","Stage2+3"])
plt.title("Normalized CM (v13 full smote)")
plt.tight_layout()
...
plt.title("ROC Curve (v13 full smote)")
...
plt.title("Performance Summary (v13 full smote)")
plt.tight_layout()
...
plt.title("Top 15 Feature Importance (v13 full smote)")
plt.tight_layout()
...
with open("models/stage2_LGBM_v13_full_smote.pkl","wb") as f:
    pickle.dump({"model":model,"feature_cols":FEATURE_COLS,
                 "best_threshold":best_t,"version":"v13_full_smote",
                 "metrics":{"valid_auroc":val_auroc,"valid_s23r":val_s23r,
                             "test_auroc":test_auroc,"test_s23r":test_s23r}},f)
print("MODEL SAVED : models/stage2_LGBM_v13_full_smote.pkl")
print("FINISHED")