# ==========================================================
# 09_modeling_LGBM_v13_exc_manual_weight.py
# Stage1 vs Stage2+3 | Excluded 28개 | 수동 가중치
# ==========================================================
...
OUT_DIR = "outputs/LGBM_v13_exc_manual_weight"
...
print("=" * 70)
print("LGBM v13 | Excluded 28개 | Manual Weight | Stage1 vs Stage2+3")
print("=" * 70)
...
MANUAL_WEIGHT = {0: 0.5, 1: 5.0}
sw = np.array([MANUAL_WEIGHT[y] for y in y_tr])
print(f"Manual Weight: Stage1={MANUAL_WEIGHT[0]}, Stage2+3={MANUAL_WEIGHT[1]}")
...
plt.title("Confusion Matrix (v13 exc manual_weight)"); plt.tight_layout()
...
sns.heatmap(cm_pct,annot=True,fmt='.1%',cmap='Blues',
            xticklabels=["Stage1","Stage2+3"],yticklabels=["Stage1","Stage2+3"])
plt.title("Normalized CM (v13 exc manual_weight)"); plt.tight_layout()
...
plt.title("ROC Curve (v13 exc manual_weight)")
...
plt.title("Performance (v13 exc manual_weight)"); plt.tight_layout()
...
plt.title("Top 15 (v13 exc manual_weight)")
