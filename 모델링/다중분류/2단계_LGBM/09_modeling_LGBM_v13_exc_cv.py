# ==========================================================
# 09_modeling_LGBM_v13_exc_cv.py
# Stage1 vs Stage2+3 | Excluded 28개 | 5-Fold CV
# ==========================================================
...
OUT_DIR = "outputs/LGBM_v13_exc_cv"
...
print("=" * 70)
print("LGBM v13 | Excluded 28개 | 5-Fold CV | Stage1 vs Stage2+3")
print("=" * 70)
...
plt.title("Confusion Matrix (v13 exc cv)"); plt.tight_layout()
...
sns.heatmap(cm_pct,annot=True,fmt='.1%',cmap='Blues',
            xticklabels=["Stage1","Stage2+3"],yticklabels=["Stage1","Stage2+3"])
plt.title("Normalized CM (v13 exc cv)"); plt.tight_layout()
...
plt.title("ROC Curve (v13 exc cv)")
...
plt.title("Performance (v13 exc cv)"); plt.tight_layout()
...
with open("models/stage2_LGBM_v13_exc_cv.pkl","wb") as f:
...
print("MODEL SAVED : models/stage2_LGBM_v13_exc_cv.pkl")
print("FINISHED")