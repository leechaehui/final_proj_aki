# ==========================================================
# 09_modeling_LGBM_v13_exc_smote.py
# Stage1 vs Stage2+3 | Excluded 28개 | SMOTE
# ==========================================================
...
OUT_DIR = "outputs/LGBM_v13_exc_smote"
...
print("=" * 70)
print("LGBM v13 | Excluded 28개 | SMOTE | Stage1 vs Stage2+3")
print("=" * 70)
...
print(f"Before SMOTE: Stage1={sum(y_tr==0)}, Stage2+3={sum(y_tr==1)}")
...
plt.title("Confusion Matrix (v13 exc smote)"); plt.tight_layout()
...
sns.heatmap(cm_pct,annot=True,fmt='.1%',cmap='Blues',
            xticklabels=["Stage1","Stage2+3"],yticklabels=["Stage1","Stage2+3"])
plt.title("Normalized CM (v13 exc smote)"); plt.tight_layout()
...
plt.title("ROC Curve (v13 exc smote)")
...
plt.title("Performance (v13 exc smote)"); plt.tight_layout()
...
plt.title("Top 15 (v13 exc smote)")
