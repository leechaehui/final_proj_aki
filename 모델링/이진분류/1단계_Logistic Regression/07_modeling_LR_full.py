...
disp.plot()
plt.title("Validation Confusion Matrix (LR Full)")
plt.tight_layout()
...
plt.ylabel("Actual")
plt.title("Normalized Confusion Matrix (LR Full)")
plt.tight_layout()
...
plt.title(f"PR Curve (LR Full) | AUPRC={val_auprc:.4f}")
plt.tight_layout()
...
plt.ylabel("Count")
plt.title("Probability Distribution (LR Full)")
plt.legend()
plt.tight_layout()
...
plt.ylabel("Score")
plt.title("Threshold Optimization (LR Full)")
plt.legend()
plt.tight_layout()
...
plt.title("Validation Performance Summary (LR Full)")
plt.ylabel("Score")
plt.tight_layout()
...
plt.ylabel("AUROC")
plt.title("Train / Validation / Test AUROC (LR Full)")
plt.tight_layout()
...
plt.title("Top 15 Feature Coefficients (LR Full)")
plt.tight_layout()
...
with open("models/stage1_LR_full.pkl", "wb") as f:
    pickle.dump({
        "model"          : model,
...
print("=" * 70)
print("MODEL SAVED : models/stage1_LR_full.pkl")
print("=" * 70)
print("FINISHED")