...
print("=" * 70)
print("OPTUNA TUNING v2 (30 trials, 범위 제한)")
print("=" * 70)
...
disp.plot()
plt.title("Validation Confusion Matrix (RF v2 Full)")
plt.tight_layout()
...
plt.ylabel("Actual")
plt.title("Normalized Confusion Matrix (RF v2 Full)")
plt.tight_layout()
...
plt.title("ROC Curve (RF v2 Full)")
plt.legend()
plt.tight_layout()
...
plt.title(f"PR Curve (RF v2 Full) | AUPRC={val_auprc:.4f}")
plt.tight_layout()
...
plt.ylabel("Count")
plt.title("Probability Distribution (RF v2 Full)")
plt.legend()
plt.tight_layout()
...
plt.ylabel("Score")
plt.title("Threshold Optimization (RF v2 Full)")
plt.legend()
plt.tight_layout()
...
plt.title("Validation Performance Summary (RF v2 Full)")
plt.ylabel("Score")
plt.tight_layout()
...
plt.ylabel("AUROC")
plt.title("Train / Validation / Test AUROC (RF v2 Full)")
plt.tight_layout()
...
plt.title("Top 15 Feature Importance (RF v2 Full)")
plt.tight_layout()
...
plt.xlabel("Trial")
plt.ylabel("AUPRC")
plt.title("Optuna Trial History (RF v2 Full)")
plt.tight_layout()
...
with open("models/stage1_RF_v2_full.pkl", "wb") as f:
    pickle.dump({
        "model"         : model,
...
print("=" * 70)
print("MODEL SAVED : models/stage1_RF_v2_full.pkl")
print("=" * 70)
print("FINISHED")